      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="text-muted-foreground">
            Welcome to our online store. We respect your privacy and are committed to protecting your personal data.
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
            ...
            <li><strong>Contact Data:</strong> includes email address and contact preferences</li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
            ...
            <li>To provide you with news, special offers and general information about products and services</li>
          </ul>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-3">4. Third-Party Services - eBay</h2>
          <p className="text-muted-foreground mb-3">
            <strong>Important Notice:</strong> Our website serves as a product showcase and catalog. When you click on
            product links or "Buy Now" buttons, you will be redirected to eBay's platform to complete your purchase.
          </p>
          <p className="text-muted-foreground mb-3">
            <strong>What this means for your data:</strong>
          </p>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
            <li>We do not process, store, or have access to your payment information</li>
            <li>We do not collect or store your shipping address or purchase details</li>
            <li>All transactions are handled entirely by eBay and are subject to eBay's Privacy Policy and Terms of Service</li>
            <li>eBay may share certain information with us about sales originating from our website, such as commission
              data, but this does not include your personal payment or shipping information</li>
            <li>Any data you provide during the purchase process is governed by eBay's privacy practices, not ours</li>
          </ul>
          <p className="text-muted-foreground mt-3">
            We recommend reviewing <a href="https://www.ebay.com/help/policies/member-behaviour-policies/user-privacy-notice-privacy-policy?id=4260"
              target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">eBay's Privacy Policy</a> to
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            ...
            your personal data, but remember that no method of transmission over the Internet, or method of electronic
            storage is 100% secure. While we implement appropriate security measures, we cannot guarantee absolute security.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3">10. Links to Other Websites</h2>
          <p className="text-muted-foreground">
            Our website contains links to other websites (including eBay) that are not operated by us. If you click on
            a third-party link, you will be directed to that third party's site. We strongly advise you to review the
            privacy policy of every site you visit. We have no control over and assume no responsibility for the content,
